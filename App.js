...
export default class App extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { taskList: [], isMenuTaskVisible: false, currentTask: {}, isAddPromptVisible: false, isRenamePromptVisible: false, idGenerator: 0 };
  }
  ...
  displayMenuTask = (taskContent) => {
    alert('Tu me presses ?' + taskContent)
  }
  ...
  deleteCurrentTask = () => {
    ...
    list.splice(index, 1);
    this.setState({ taskList: list, currentTask: {} }, () => { this.toggleMenuTaskVisibility(); this.saveTaskList(); });
  };
  toggleTaskStatus = () => {
    ...
    this.setState({ taskList: updatedTaskList, isMenuTaskVisible: false, currentTask: {} }, () => { this.saveTaskList(); });
  };
  hideAddPrompt = () => {
  ...
  onAddTask = (value) => {
    ...
    this.setState({ taskList: [...this.state.taskList, newTask], isAddPromptVisible: false, idGenerator: this.state.idGenerator + 1 }, () => { this.saveTaskList(); });
  };
  ...
  renderTaskList = () => {
    ...
    return <View style={style.noTask}>
      <Text>
        Cliquer sur le bouton ajouter pour créer une tâche
            </Text>
    </View>
  };
  ...
  render() {
    return (
      <View style={{ flex: 1 }}>
        ...
        <TextPrompt isVisible={this.state.isAddPromptVisible}
          onCancelCallBack={this.hideAddPrompt} onSubmitCallBack={this.onAddTask}
          title={'Ajouter une nouvelle tâche'}
          placeholder={'Ex: acheter du café'}
        />
        <TextPrompt isVisible={this.state.isRenamePromptVisible}
          onCancelCallBack={this.hideRenamePrompt} onSubmitCallBack={this.renameTask}
